...
export type AuthErrorExtension<TFields extends string = string> =
  | LoginErrorExtension<TFields>
  | RegistrationErrorExtension<TFields>
  | UpdateAccessTokenErrorExtension<TFields>;
